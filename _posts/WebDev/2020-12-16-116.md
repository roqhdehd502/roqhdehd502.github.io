...
: **인스턴스의 내용 비교(Call by value)**를 위한 기능이 있는 함수로 **Object의 클래스에 선언**되어있다.
...
public class INum {
	...
	@Override // Object 클래스의 equals 메소드 오버라이딩
    // Object 클래스의 특성상 extends를 하지 않아도 자동으로 상속되기 때문에 해당 구현부를 생략해도 equals는 호출된다.
...
public class ObjectEqualsMain {
	public static void main(String[] args) {
		...
		if (num1.equals(num3)) { // 각각 새로 생성된 인스턴스 내용과의 비교이기 때문에 값이 같아도 서로 다르다
